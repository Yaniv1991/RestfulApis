...
module.exports = "<div class=\"wrapper\">\r\n  <div>\r\n      <img src=\"assets/images/Loading_Infinity.gif\" *ngIf=\"!company\">\r\n  </div>\r\n    <div [class]=\"add? 'form' : 'wrapper'\">\r\n      <form #formInfo=\"ngForm\">\r\n        <label class=\"formlabel\" >Company Name</label><input class=\"forminput\" name=\"name\" type=\"text\" [(ngModel)]=\"company.name\">\r\n        <label class=\"formlabel\" for=\"email\">Email</label><input class=\"forminput\" required name = \"email\" type=\"email\" [(ngModel)]=\"company.email\" ngModel email=\"true\">\r\n        <label class=\"formlabel\" for=\"password\">Password</label><input class=\"forminput\" required name = \"password\" type=\"password\" [(ngModel)]=\"company.password\">\r\n        <p *ngIf=\"formInfo.form.invalid && formInfo.form.dirty\" class=\"warning\">Please provide a valid email and password</p>\r\n        <button type=\"submit\" class=\"submitbutton\" (click)=\"submitChanges()\" [disabled] = \"formInfo.form.invalid\">Submit</button>\r\n      </form>\r\n    </div>\r\n</div>"
...
module.exports = "  <div [class]=\"add ? 'addForm' : 'updateForm'\">\r\n    <img src=\"assets/images/Loading_Infinity.gif\" *ngIf=\"!customer\">\r\n    <div class=\"form\" *ngIf=\"customer\">\r\n      <form #formInfo=\"ngForm\">\r\n        <label for=\"firstname\" class=\"formlabel\">First Name</label><input class=\"forminput\" type=\"text\" [(ngModel)]=\"customer.firstName\" name=\"firstName\">\r\n        <label for=\"lastname\" class=\"formlabel\">Last Name</label><input class=\"forminput\" type=\"text\" [(ngModel)]=\"customer.lastName\" name=\"lastName\">\r\n        <label for=\"email\" class=\"formlabel\">Email</label><input class=\"forminput\" type=\"email\" [(ngModel)]=\"customer.email\" required name=\"email\" ngmodel email = \"true\">\r\n        <label for=\"password\" class=\"formlabel\">Password</label><input class=\"forminput\" type=\"password\" [(ngModel)]=\"customer.password\" required name=\"password\">\r\n        <p *ngIf=\"formInfo.form.invalid && formInfo.form.dirty\" class=\"warning\">Please provide a valid email and password</p>\r\n        <button type=\"submit\" class=\"submitbutton\" (click)=\"submitChanges()\">Submit</button>\r\n      </form>\r\n    </div>\r\n  </div>\r\n  "
...
var CompaniesComponent = /** @class */ (function () {
    ...
    CompaniesComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.adminService.getAllCompanies().subscribe(function (companies) { return _this.companies = companies; }, function (error) { alert(error.message); });
    };
    CompaniesComponent.prototype.goToAdd = function () {
...
module.exports = ".wrapper {\r\n  height: 100%;\r\n  width: 100%;\r\n  overflow: auto;\r\n}\r\n.form {\r\n  width: 80%;\r\n  height: 100%;\r\n  background-color:inherit;\r\n  margin: 0 auto;\r\n  margin-top: 25px;\r\n  text-align: center;\r\n  overflow: auto;\r\n}\r\n.formlabel {\r\n  background-color: inherit;\r\n  color: white;\r\n  text-shadow: black 0.1em 0.1em 0.2em;\r\n  font-family: Courier New, monospace;\r\n  font-weight: 600;\r\n  font-stretch: expanded;\r\n  font-size: 22px;\r\n  text-align: left;\r\n  /* border: 2px solid black;\r\n  border-radius: 4px; */\r\n  display: inline-block;\r\n  padding: 5px;\r\n  width: 20%;\r\n  margin-bottom: 10px;\r\n}\r\n.forminput {\r\n  text-align: left;\r\n  display: inline-block;\r\n  width: 70%;\r\n  height: auto;\r\n  padding: 10px;\r\n  padding-left: 50px;\r\n  border: 2px solid red;\r\n  border-radius: 4px;\r\n  margin-bottom: 10px;\r\n}\r\n.submitbutton {\r\n  background-color: teal;\r\n  border: 2px solid teal;\r\n  color: white;\r\n  padding: 16px 32px;\r\n  text-align: center;\r\n  text-decoration: none;\r\n  display: inline-block;\r\n  font-size: 16px;\r\n  font-weight: bold;;\r\n  margin: 0 auto; /* Safari */\r\n  transition-duration: 0.5s;\r\n  cursor: pointer;\r\n  border-radius: 8px;\r\n  width: 50%;\r\n}\r\n.submitbutton:hover {\r\n  background-color: white;\r\n  color: teal;\r\n  border: 2px solid teal;\r\n}\r\n.warning {\r\n  width: 60%;\r\n  margin: 0 auto;\r\n  padding: 5px;\r\n  color: black;\r\n  font-family: Courier New, monospace;\r\n  font-weight: 800;\r\n  font-size: 22px;\r\n  border: 4px dashed red;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CompanyAddUpdateComponent = /** @class */ (function () {
    function CompanyAddUpdateComponent(activatedRoute, adminService, router) {
        this.activatedRoute = activatedRoute;
        this.adminService = adminService;
        this.router = router;
    }
    CompanyAddUpdateComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.url = '/companies';
        var str = this.activatedRoute.snapshot.params.id.toString();
        // tslint:disable-next-line: radix
        this.id = +str;
        // tslint:disable-next-line: triple-equals
        this.add = (this.id == 0);
        if (!this.add) {
            this.adminService.getCompanyById(this.id).subscribe(function (company) { return _this.company = company; }, function (error) { alert(error.message); });
        }
        else {
            this.company = new src_app_models_company__WEBPACK_IMPORTED_MODULE_3__["Company"](this.id, '', '', '');
        }
    };
    CompanyAddUpdateComponent.prototype.submitChanges = function () {
        var _this = this;
        if (this.add) {
            this.adminService.addCompany(this.company).subscribe(function () { _this.router.navigateByUrl(_this.url); }, function (error) { alert(error.message); });
        }
        else {
            this.adminService.updateCompany(this.company).subscribe(function () { _this.router.navigateByUrl(_this.url); }, function (error) { alert(error.message); });
        }
    };
    CompanyAddUpdateComponent.ctorParameters = function () { return [
    ...
    return CompanyAddUpdateComponent;
}());
...
var CompanyComponent = /** @class */ (function () {
    function CompanyComponent(adminService, promptService, router) {
        this.adminService = adminService;
    ...
    CompanyComponent.prototype.promptMessage = function () {
        var _this = this;
        this.promptService.promptBeforeDelete('Delete Company ' + this.company.name, function () { _this.deleteCompany(); });
    };
...
var CouponAddUpdateComponent = /** @class */ (function () {
    function CouponAddUpdateComponent(activatedRoute, couponService, companyService, router) {
        this.activatedRoute = activatedRoute;
    ...
    CouponAddUpdateComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.add = this.id == 0;
        if (!this.add) {
            this.couponService.getSingleCoupon(this.id).subscribe(function (coupon) { return _this.coupon = coupon; }, function (error) { alert(error.message); });
        }
        else {
    ...
    CouponAddUpdateComponent.prototype.submitChanges = function () {
        var _this = this;
        if (this.add) {
            this.companyService.addCoupon(this.coupon).subscribe(function () { _this.router.navigateByUrl(_this.url); }, function (error) { alert(error.message); });
        }
        else {
            this.companyService.updateCoupon(this.coupon).subscribe(function () { _this.router.navigateByUrl(_this.url); }, function (error) { alert(error.message); });
        }
    };
    CouponAddUpdateComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    ...
    return CouponAddUpdateComponent;
}());
...
var CouponComponent = /** @class */ (function () {
    function CouponComponent(couponService, companyService, customerService, promptService, activatedRoute, router) {
        this.couponService = couponService;
        this.companyService = companyService;
    ...
    CouponComponent.prototype.ngOnInit = function () {
        var _this = this;
        var id = this.coupon ? this.coupon.id : this.activatedRoute.snapshot.params.id;
        this.couponService.getSingleCoupon(id).subscribe(function (coupon) {
            _this.coupon = coupon;
            // tslint:disable-next-line: triple-equals
            _this.url = '/couponAddOrUpdate/' + _this.coupon.id;
        }, function (error) { alert(error.message); });
    };
    CouponComponent.prototype.promptMessage = function () {
        var _this = this;
        this.promptService.promptBeforeDelete('Delete Coupon ' + this.coupon.title, function () { _this.deleteCoupon(); });
    };
    CouponComponent.prototype.deleteCoupon = function () {
        var _this = this;
        this.companyService.removeCoupon(this.coupon)
            .subscribe(function () {
            _this.router.navigateByUrl('/RefreshComponent', { skipLocationChange: true }).then(function () {
                _this.router.navigateByUrl('/coupons/company');
            });
        }, function (error) { alert(error.message); });
    };
    CouponComponent.prototype.purchaseCoupon = function () {
        var _this = this;
        this.customerService.purchase(this.coupon)
            .subscribe(function () {
            _this.router.navigateByUrl('/RefreshComponent', { skipLocationChange: true }).then(function () {
                _this.router.navigateByUrl('/coupons/isCustomer');
            });
        }, function (error) { alert(error.message); });
    };
...
var CouponsComponent = /** @class */ (function () {
    function CouponsComponent(service, activatedRoute, router) {
    ...
    CouponsComponent.prototype.ngOnInit = function () {
        ...
        this.service.getCoupons(this.purchased).subscribe(function (list) { _this.coupons = list; }, function (error) { alert(error.message); });
    };
    CouponsComponent.prototype.searchByType = function () {
        var _this = this;
        if (this.couponType.toString() === 'ALL') {
            this.service.getCoupons(this.purchased).subscribe(function (list) { _this.coupons = list; });
        }
        else {
            this.service.getByType(this.couponType, this.isCustomer).subscribe(function (coupons) { _this.coupons = coupons; }, function (error) { alert(error.message); });
        }
    };
    CouponsComponent.prototype.searchByPrice = function () {
        var _this = this;
        this.service.getByPrice(this.price, this.isCustomer).subscribe(function (coupons) { _this.coupons = coupons; }, function (error) { alert(error.message); });
    };
    CouponsComponent.prototype.searchByEndDate = function () {
        var _this = this;
        this.service.getByEndDate(this.purchased, this.endDate).subscribe(function (coupons) { _this.coupons = coupons; }, function (error) { alert(error.message); });
    };
...
module.exports = ".form {\r\n  width: 80%;\r\n  height: 80%;\r\n  background-color:inherit;\r\n  margin: 0 auto;\r\n  margin-top: 25px;\r\n  text-align: center;\r\n}\r\n.formlabel {\r\n  background-color: inherit;\r\n  color: white;\r\n  text-shadow: black 0.1em 0.1em 0.2em;\r\n  font-family: Courier New, monospace;\r\n  font-weight: 600;\r\n  font-stretch: expanded;\r\n  font-size: 22px;\r\n  text-align: left;\r\n  /* border: 2px solid black;\r\n  border-radius: 4px; */\r\n  display: inline-block;\r\n  padding: 5px;\r\n  width: 20%;\r\n  margin-bottom: 10px;\r\n}\r\n.forminput {\r\n  text-align: left;\r\n  display: inline-block;\r\n  width: 70%;\r\n  height: auto;\r\n  padding: 10px;\r\n  padding-left: 50px;\r\n  border: 2px solid red;\r\n  border-radius: 4px;\r\n  margin-bottom: 10px;\r\n}\r\n.submitbutton {\r\n  background-color: teal;\r\n  border: 2px solid teal;\r\n  color: white;\r\n  padding: 16px 32px;\r\n  text-align: center;\r\n  text-decoration: none;\r\n  display: inline-block;\r\n  font-size: 16px;\r\n  font-weight: bold;;\r\n  margin: 0 auto; /* Safari */\r\n  transition-duration: 0.5s;\r\n  cursor: pointer;\r\n  border-radius: 8px;\r\n  width: 50%;\r\n}\r\n.submitbutton:hover {\r\n  background-color: white;\r\n  color: teal;\r\n  border: 2px solid teal;\r\n}\r\n.warning {\r\n  width: 60%;\r\n  margin: 0 auto;\r\n  padding: 5px;\r\n  color: black;\r\n  font-family: Courier New, monospace;\r\n  font-weight: 800;\r\n  font-size: 22px;\r\n  border: 4px dashed red;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var CustomerAddUpdateComponent = /** @class */ (function () {
    function CustomerAddUpdateComponent(activatedRoute, customerService, adminService, router) {
        this.activatedRoute = activatedRoute;
        this.customerService = customerService;
        this.adminService = adminService;
        this.router = router;
    }
    CustomerAddUpdateComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.url = '/customers';
        var str = this.activatedRoute.snapshot.params.id.toString();
        this.id = +str;
        ...
        this.add = this.id === 0;
        if (!this.add) {
            this.customerService.getCustomerById(this.id).subscribe(function (customer) { return _this.customer = customer; });
        }
        else {
            this.customer = new src_app_models_customer__WEBPACK_IMPORTED_MODULE_2__["Customer"](this.id, '', '', '');
        }
    };
    CustomerAddUpdateComponent.prototype.submitChanges = function () {
        var _this = this;
        if (this.add) {
            this.adminService.addCustomer(this.customer).subscribe(function () { _this.router.navigateByUrl(_this.url); });
        }
        else {
            this.adminService.updateCustomer(this.customer).subscribe(function () { _this.router.navigateByUrl(_this.url); });
        }
    };
    CustomerAddUpdateComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    ...
    return CustomerAddUpdateComponent;
}());
...
var CustomerComponent = /** @class */ (function () {
    function CustomerComponent(customerService, adminService, promptService, router) {
        this.customerService = customerService;
        this.adminService = adminService;
        this.promptService = promptService;
        this.router = router;
    ...
    CustomerComponent.prototype.promptMessage = function () {
        var _this = this;
        this.promptService.promptBeforeDelete('Delete Customer ' + this.customer.name, function () { _this.deleteCustomer(); });
    };
...
var CustomersComponent = /** @class */ (function () {
    function CustomersComponent(adminService, client, router) {
        this.adminService = adminService;
        this.client = client;
        this.router = router;
    }
    CustomersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.adminService.getAllCustomers().subscribe(function (customers) { return _this.customers = customers; }, function (error) { alert(error.message); });
    };
...
module.exports = "* {\r\n  box-sizing: border-box;\r\n}\r\n.loginForm {\r\n  width: 80%;\r\n  height: 80%;\r\n  background-color:inherit;\r\n  margin: 0 auto;\r\n  text-align: center;\r\n}\r\n.header {\r\n  background-color: inherit;\r\n  font-family: Arial, Helvetica, sans-serif;\r\n  font-size: 18px;\r\n  font-weight: bold;\r\n  margin: 0 auto;\r\n  text-align: center;\r\n}\r\n.formLabel {\r\n  background-color: inherit;\r\n  color: white;\r\n  text-shadow: black 0.1em 0.1em 0.2em;\r\n  font-family: Courier New, monospace;\r\n  font-weight: 600;\r\n  font-stretch: expanded;\r\n  font-size: 22px;\r\n  text-align: left;\r\n  /* border: 2px solid black;\r\n  border-radius: 4px; */\r\n  display: inline-block;\r\n  padding: 5px;\r\n  width: 25%;\r\n  margin-bottom: 10px;\r\n}\r\n.forminput {\r\n  text-align: left;\r\n  display: inline-block;\r\n  width: 75%;\r\n  height: auto;\r\n  padding: 10px;\r\n  padding-left: 50px;\r\n  border: 2px solid red;\r\n  border-radius: 4px;\r\n  margin-bottom: 10px;\r\n}\r\n.email {\r\n  background-image: url('/assets/images/emailicon.png');\r\n  background-position: left;\r\n  background-repeat: no-repeat;\r\n}\r\n.password {\r\n  background-image: url('/assets/images/passwordicon.png');\r\n  background-position: left;\r\n  background-repeat: no-repeat;\r\n}\r\n.clientType {\r\n  background-image: url('/assets/images/usericon.png');\r\n  background-position: left;\r\n  background-repeat: no-repeat;\r\n}\r\n.textBox {\r\n  width: 60%;\r\n}\r\n.userLoggedIn {\r\n  width: 100%;\r\n  height: 100%;\r\n  background-color: aquamarine;\r\n  margin: 0 auto;\r\n}\r\n.loggedText {\r\n  background-color: inherit;\r\n  font-family: Arial, Helvetica, sans-serif;\r\n  font-size: 20px;\r\n}\r\n.submitbutton {\r\n  background-color: teal;\r\n  border: 2px solid teal;\r\n  color: white;\r\n  padding: 16px 32px;\r\n  text-align: center;\r\n  text-decoration: none;\r\n  display: inline-block;\r\n  font-size: 16px;\r\n  font-weight: bold;;\r\n  margin: 0 auto; /* Safari */\r\n  transition-duration: 0.5s;\r\n  cursor: pointer;\r\n  border-radius: 8px;\r\n  width: 50%;\r\n}\r\n.submitbutton:hover {\r\n  background-color: white;\r\n  color: teal;\r\n  border: 2px solid teal;\r\n}\r\n.warning {\r\n  width: 60%;\r\n  margin: 0 auto;\r\n  padding: 5px;\r\n  color: black;\r\n  font-family: Courier New, monospace;\r\n  font-weight: 800;\r\n  font-size: 22px;\r\n  border: 4px dashed red;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(authenticationService, menuComponent) {
    ...
    LoginComponent.prototype.isInvalid = function () {
        return this.loginForm.invalid;
    };
    LoginComponent.prototype.onSubmit = function () {
        var _this = this;
        this.authenticationService.login(this.email, this.password, this.clientType, function () {
            _this.menuComponent.refresh();
        }, function () { alert('No user matching the credentials was found'); })
            .subscribe(function (clientType) { _this.clientType = clientType; _this.submitted = true; });
    };
    LoginComponent.prototype.logout = function () {
        var _this = this;
        this.authenticationService.logout(function () { return _this.submitted = false; });
    };
...
var MenuComponent = /** @class */ (function () {
    function MenuComponent(menuService, authenticationService, router) {
        var _this = this;
        this.menuService = menuService;
        this.authenticationService = authenticationService;
        this.router = router;
        this.menuService.getMenuItems().subscribe(function (mi) {
            _this.menuItems = mi;
        }, function (error) { alert(error.message); });
    }
...
var Coupon = /** @class */ (function () {
    function Coupon(id, amount, title, description, couponType, price, startDate, endDate, image) {
        this.id = id;
        this.amount = amount;
        this.title = title;
...
var Customer = /** @class */ (function () {
    function Customer(id, name, email, password) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.password = password;
...
var AdminService = /** @class */ (function () {
    ...
    AdminService.prototype.deleteCustomer = function (customer) {
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(httpClient, cookieService) {
        this.httpClient = httpClient;
        this.cookieService = cookieService;
        this.loginUrl = "http://localhost:8080/Rest/Login";
    }
    AuthenticationService.prototype.getClientType = function () {
    ...
    AuthenticationService.prototype.login = function (email, password, clientType, success, failure) {
        var _this = this;
        this.user = { email: email, password: password, clientType: clientType };
        this.httpClient.post(this.loginUrl, this.user, { withCredentials: true }).subscribe(function (userFromDB) {
            if (userFromDB) {
                _this.user = userFromDB;
                _this.cookieService.set('clientType', clientType.toString());
                success();
                // tslint:disable-next-line:no-shadowed-variable
                return new rxjs__WEBPACK_IMPORTED_MODULE_5__["Observable"](function (clientType) { return clientType; });
            }
            else {
                _this.cookieService.delete('clientType');
                failure();
            }
        });
        // tslint:disable-next-line:no-shadowed-variable
    ...
    AuthenticationService.prototype.logout = function (success) {
        var _this = this;
        this.httpClient.get("http://localhost:8080/Rest/Logout").subscribe(function () {
            _this.user = null;
            _this.cookieService.delete('clientType');
            if (success) {
                success();
...
var CompanyService = /** @class */ (function () {
    ...
    CompanyService.prototype.getCoupons = function () {
        var methodCoupons;
        this.couponService.getCoupons(false).subscribe(function (couponsFromService) { methodCoupons = couponsFromService; });
        return methodCoupons;
    };
    CompanyService.prototype.getSingle = function (id) {
        this.couponService.getSingleCoupon(id).subscribe(function (singleCoupon) { return singleCoupon; });
        return null; // ??
    };
    ...
    CompanyService.prototype.getByType = function (type) {
        this.couponService.getByType(type, false).subscribe(function (couponFromService) { return couponFromService; });
        return null;
    };
...
var CouponService = /** @class */ (function () {
    ...
    CouponService.prototype.getCoupons = function (getAllPurchasedCoupons) {
        if (getAllPurchasedCoupons === void 0) { getAllPurchasedCoupons = false; }
    ...
    CouponService.prototype.getSingleCoupon = function (id) {
        return this.httpClient.get(this.visitorRootUrl + "/GetOne/" + id, { withCredentials: true });
    };
    CouponService.prototype.getByType = function (type, customer) {
        if (customer) {
    ...
    CouponService.prototype.getByPrice = function (price, isCustomer) {
        var priceContextPath = '/GetAllCouponsByPrice?price=';
        if (isCustomer) {
    ...
    CouponService.prototype.getByEndDate = function (purchasedCoupons, endDate) {
        if (purchasedCoupons) {
            return this.httpClient.get(this.customerRootUrl +
...
var CustomerService = /** @class */ (function () {
    ...
    CustomerService.prototype.purchase = function (coupon) {
        return this.httpClient.post(this.customerRootUrl + "/Purchase", coupon, { withCredentials: true });
    };
    CustomerService.prototype.getCoupons = function () {
        this.couponService.getCoupons(true).subscribe(function (couponsFromService) { return couponsFromService; });
        return null;
    };
    CustomerService.prototype.getByType = function (type) {
        this.couponService.getByType(type, true).subscribe(function (couponList) { return couponList; });
        return null;
    };
    CustomerService.prototype.getByPrice = function (price) {
        this.couponService.getByPrice(price, true).subscribe(function (list) { return list; });
        return null;
    };
...
var MenuService = /** @class */ (function () {
    function MenuService(httpClient, authenticationService) {
        this.httpClient = httpClient;
        this.authenticationService = authenticationService;
    }
    ...
    MenuService.prototype.getMenuItemsByClientType = function () {
...
var PromptService = /** @class */ (function () {
    ...
    PromptService.prototype.promptBeforeDelete = function (message, action) {
